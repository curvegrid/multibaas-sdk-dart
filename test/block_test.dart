...
void main() {
  ...
  group(Block, () {
    ...
    // The keccak256 hash as a hex string of 256 bits.
    // String receiptsRoot
    test('to test the property `receiptsRoot`', () async {
      // TODO
    });
    ...
    // The keccak256 hash as a hex string of 256 bits.
    // String sha3Uncles
    test('to test the property `sha3Uncles`', () async {
      // TODO
    });

    // An ethereum address.
    // String miner
    test('to test the property `miner`', () async {
      // TODO
    });

    // The keccak256 hash as a hex string of 256 bits.
    // String stateRoot
    test('to test the property `stateRoot`', () async {
      // TODO
    });

    // The keccak256 hash as a hex string of 256 bits.
    // String transactionsRoot
    test('to test the property `transactionsRoot`', () async {
      // TODO
    });

    // A hex string.
    // String logsBloom
    test('to test the property `logsBloom`', () async {
      // TODO
    });
    ...
    // The keccak256 hash as a hex string of 256 bits.
    // String mixHash
    test('to test the property `mixHash`', () async {
      // TODO
    });
    ...
    test('to test the property `baseFeePerGas`', () async {
      // TODO
    });
