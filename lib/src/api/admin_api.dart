...
class AdminApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AcceptInvite200Response] as data
  ...
  Future<Response<AcceptInvite200Response>> acceptInvite({ 
    ...
    final _path = r'/invites/{inviteID}'.replaceAll('{' r'inviteID' '}', encodeQueryParameter(_serializers, inviteID, const FullType(String)).toString());
    ...
    AcceptInvite200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AcceptInvite200Response),
      ) as AcceptInvite200Response;
    ...
    return Response<AcceptInvite200Response>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> addGroupApiKey({ 
    ...
    final _path = r'/groups/{groupID}/api_keys/{apiKeyID}'.replaceAll('{' r'groupID' '}', encodeQueryParameter(_serializers, groupID, const FullType(int)).toString()).replaceAll('{' r'apiKeyID' '}', encodeQueryParameter(_serializers, apiKeyID, const FullType(int)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> addGroupRole({ 
    required int groupID,
    ...
    final _path = r'/groups/{groupID}/roles/{roleShortName}'.replaceAll('{' r'groupID' '}', encodeQueryParameter(_serializers, groupID, const FullType(int)).toString()).replaceAll('{' r'roleShortName' '}', encodeQueryParameter(_serializers, roleShortName, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> addGroupUser({ 
    required int groupID,
    required int userID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/groups/{groupID}/users/{userID}'.replaceAll('{' r'groupID' '}', encodeQueryParameter(_serializers, groupID, const FullType(int)).toString()).replaceAll('{' r'userID' '}', encodeQueryParameter(_serializers, userID, const FullType(int)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> checkInvite({ 
    required String inviteID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> deleteApiKey({ 
    required int apiKeyID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api_keys/{apiKeyID}'.replaceAll('{' r'apiKeyID' '}', encodeQueryParameter(_serializers, apiKeyID, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> deleteUser({ 
    required int userID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{userID}'.replaceAll('{' r'userID' '}', encodeQueryParameter(_serializers, userID, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [all] - If true, returns all API keys on the system, otherwise, returns only the API keys owned by the calling user.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListApiKeys200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListApiKeys200Response>> listApiKeys({ 
    bool? all,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    ListApiKeys200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListApiKeys200Response),
      ) as ListApiKeys200Response;
    ...
    return Response<ListApiKeys200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ListAuditLogs200Response>> listAuditLogs({ 
    ...
    final _path = r'/systemactivities';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListCorsOrigins200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListCorsOrigins200Response>> listCorsOrigins({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ListCorsOrigins200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListCorsOrigins200Response),
      ) as ListCorsOrigins200Response;
    ...
    return Response<ListCorsOrigins200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListGroups200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListGroups200Response>> listGroups({ 
    int? userID,
    int? apiKeyID,
    bool? assignable,
    CancelToken? cancelToken,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (apiKeyID != null) r'apiKeyID': encodeQueryParameter(_serializers, apiKeyID, const FullType(int)),
      if (assignable != null) r'assignable': encodeQueryParameter(_serializers, assignable, const FullType(bool)),
    };
    ...
    ListGroups200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListGroups200Response),
      ) as ListGroups200Response;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListUserSigners200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListUserSigners200Response>> listUserSigners({ 
    required int userID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{userID}/signers'.replaceAll('{' r'userID' '}', encodeQueryParameter(_serializers, userID, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ListUserSigners200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListUserSigners200Response),
      ) as ListUserSigners200Response;
    ...
    return Response<ListUserSigners200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListUsers200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListUsers200Response>> listUsers({ 
    int? groupID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    ListUsers200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListUsers200Response),
    ...
    return Response<ListUsers200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> removeCorsOrigin({ 
    ...
    final _path = r'/cors/{originID}'.replaceAll('{' r'originID' '}', encodeQueryParameter(_serializers, originID, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> removeGroupApiKey({ 
    required int groupID,
    required int apiKeyID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> removeGroupRole({ 
    required int groupID,
    required String roleShortName,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> removeGroupUser({ 
    required int groupID,
    required int userID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> removeUserSignerCloudWallet({ 
    required int userID,
    ...
    final _path = r'/users/{userID}/cloudwallets/{wallet_address}'.replaceAll('{' r'userID' '}', encodeQueryParameter(_serializers, userID, const FullType(int)).toString()).replaceAll('{' r'wallet_address' '}', encodeQueryParameter(_serializers, walletAddress, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> removeUserSignerWeb3Wallet({ 
    required int userID,
    required String walletAddress,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/users/{userID}/web3wallets/{wallet_address}'.replaceAll('{' r'userID' '}', encodeQueryParameter(_serializers, userID, const FullType(int)).toString()).replaceAll('{' r'wallet_address' '}', encodeQueryParameter(_serializers, walletAddress, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> setUserSignerCloudWallet({ 
    required int userID,
    required String walletAddress,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
