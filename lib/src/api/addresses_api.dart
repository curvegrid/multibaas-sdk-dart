...
class AddressesApi {
  ...
  Future<Response<SetAddress201Response>> getAddress({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (include != null) r'include': encodeCollectionQueryParameter<String>(_serializers, include, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
    };
  ...
  Future<Response<ListAddresses200Response>> listAddresses({ 
    ...
    final _path = r'/chains/{chain}/addresses'.replaceAll('{' r'chain' '}', encodeQueryParameter(_serializers, chain, const FullType(ChainName)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListAddresses200Response),
      ) as ListAddresses200Response;
