...
class ContractsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CallContractFunction200Response] as data
  ...
  Future<Response<CallContractFunction200Response>> callContractFunction({ 
    ...
    CallContractFunction200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CallContractFunction200Response),
      ) as CallContractFunction200Response;
    ...
    return Response<CallContractFunction200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetContract200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetContract200Response>> createContract({ 
    ...
    final _path = r'/contracts/{contract}'.replaceAll('{' r'contract' '}', encodeQueryParameter(_serializers, contract, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetContract200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetContract200Response),
    ...
    return Response<GetContract200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> deleteContract({ 
    required String contract,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> deleteContractVersion({ 
    required String contract,
    ...
    final _path = r'/contracts/{contract}/{version}'.replaceAll('{' r'contract' '}', encodeQueryParameter(_serializers, contract, const FullType(String)).toString()).replaceAll('{' r'version' '}', encodeQueryParameter(_serializers, version, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DeployContract200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeployContract200Response>> deployContract({ 
    ...
    final _path = r'/contracts/{contract}/deploy'.replaceAll('{' r'contract' '}', encodeQueryParameter(_serializers, contract, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DeployContract200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DeployContract200Response),
      ) as DeployContract200Response;
    ...
    return Response<DeployContract200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<DeployContract200Response>> deployContractVersion({ 
    ...
    final _path = r'/contracts/{contract}/{version}/deploy'.replaceAll('{' r'contract' '}', encodeQueryParameter(_serializers, contract, const FullType(String)).toString()).replaceAll('{' r'version' '}', encodeQueryParameter(_serializers, version, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GetContract200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetContract200Response>> getContract({ 
    required String contract,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [GetContract200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetContract200Response>> getContractVersion({ 
    required String contract,
    required String version,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetContractVersions200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetContractVersions200Response>> getContractVersions({ 
    required String contract,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/contracts/{contract}/all'.replaceAll('{' r'contract' '}', encodeQueryParameter(_serializers, contract, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetContractVersions200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetContractVersions200Response),
      ) as GetContractVersions200Response;
    ...
    return Response<GetContractVersions200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetEventMonitorStatus200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetEventMonitorStatus200Response>> getEventMonitorStatus({ 
    ...
    GetEventMonitorStatus200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetEventMonitorStatus200Response),
      ) as GetEventMonitorStatus200Response;
    ...
    return Response<GetEventMonitorStatus200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetEventTypeConversions200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetEventTypeConversions200Response>> getEventTypeConversions({ 
    required String contract,
    required String version,
    ...
    final _path = r'/contracts/{contract}/{version}/events/{event}'.replaceAll('{' r'contract' '}', encodeQueryParameter(_serializers, contract, const FullType(String)).toString()).replaceAll('{' r'version' '}', encodeQueryParameter(_serializers, version, const FullType(String)).toString()).replaceAll('{' r'event' '}', encodeQueryParameter(_serializers, event, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetEventTypeConversions200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetEventTypeConversions200Response),
      ) as GetEventTypeConversions200Response;
    ...
    return Response<GetEventTypeConversions200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetFunctionTypeConversions200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetFunctionTypeConversions200Response>> getFunctionTypeConversions({ 
    required String contract,
    required String version,
    required String method,
    CancelToken? cancelToken,
    ...
    final _path = r'/contracts/{contract}/{version}/methods/{method}'.replaceAll('{' r'contract' '}', encodeQueryParameter(_serializers, contract, const FullType(String)).toString()).replaceAll('{' r'version' '}', encodeQueryParameter(_serializers, version, const FullType(String)).toString()).replaceAll('{' r'method' '}', encodeQueryParameter(_serializers, method, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetFunctionTypeConversions200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetFunctionTypeConversions200Response),
      ) as GetFunctionTypeConversions200Response;
    ...
    return Response<GetFunctionTypeConversions200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SetAddress201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SetAddress201Response>> linkAddressContract({ 
    ...
    SetAddress201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SetAddress201Response),
      ) as SetAddress201Response;
    ...
    return Response<SetAddress201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListContractVersions200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListContractVersions200Response>> listContractVersions({ 
    required String contract,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/contracts/{contract}/versions'.replaceAll('{' r'contract' '}', encodeQueryParameter(_serializers, contract, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ListContractVersions200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListContractVersions200Response),
      ) as ListContractVersions200Response;
    ...
    return Response<ListContractVersions200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListContracts200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListContracts200Response>> listContracts({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ListContracts200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListContracts200Response),
      ) as ListContracts200Response;
    ...
    return Response<ListContracts200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> setEventTypeConversions({ 
    required String contract,
    required String version,
    required String event,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> setFunctionTypeConversions({ 
    required String contract,
    required String version,
    required String method,
