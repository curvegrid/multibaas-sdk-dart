...
class HsmApi {
  ...
  const HsmApi(this._dio, this._serializers);
  ...
  Future<Response<CreateHsmKey200Response>> createHsmKey({ 
    ...
    CreateHsmKey200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateHsmKey200Response),
      ) as CreateHsmKey200Response;
    ...
    return Response<CreateHsmKey200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListHsm200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListHsm200Response>> listHsm({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ListHsm200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListHsm200Response),
      ) as ListHsm200Response;
    ...
    return Response<ListHsm200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [keyName] - Filter wallets by a key name.
  /// * [keyVersion] - Filter wallets by a key version.
  /// * [vaultName] - Filter wallets by a vault name.
  /// * [baseGroupName] - Filter wallets by a base group name.
  /// * [clientId] - Filter wallets by a client ID.
  /// * [publicAddress] - Filter wallets by a public address.
  /// * [limit] 
  /// * [offset] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListHsmWallets200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListHsmWallets200Response>> listHsmWallets({ 
    String? keyName,
    String? keyVersion,
    String? vaultName,
    ...
    final _queryParameters = <String, dynamic>{
      if (keyName != null) r'key_name': encodeQueryParameter(_serializers, keyName, const FullType(String)),
      if (keyVersion != null) r'key_version': encodeQueryParameter(_serializers, keyVersion, const FullType(String)),
      if (vaultName != null) r'vault_name': encodeQueryParameter(_serializers, vaultName, const FullType(String)),
      if (baseGroupName != null) r'base_group_name': encodeQueryParameter(_serializers, baseGroupName, const FullType(String)),
      if (clientId != null) r'client_id': encodeQueryParameter(_serializers, clientId, const FullType(String)),
      if (publicAddress != null) r'public_address': encodeQueryParameter(_serializers, publicAddress, const FullType(String)),
    ...
    ListHsmWallets200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListHsmWallets200Response),
      ) as ListHsmWallets200Response;
    ...
    return Response<ListHsmWallets200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> removeHsmConfig({ 
    ...
    final _path = r'/hsm/config/{client_id}'.replaceAll('{' r'client_id' '}', encodeQueryParameter(_serializers, clientId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BaseResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> removeHsmKey({ 
    ...
    final _path = r'/hsm/key/{wallet_address}'.replaceAll('{' r'wallet_address' '}', encodeQueryParameter(_serializers, walletAddress, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BaseResponse>> setLocalNonce({ 
    ...
    final _path = r'/chains/{chain}/hsm/nonce/{wallet_address}'.replaceAll('{' r'chain' '}', encodeQueryParameter(_serializers, chain, const FullType(ChainName)).toString()).replaceAll('{' r'wallet_address' '}', encodeQueryParameter(_serializers, walletAddress, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TransferEth200Response>> signAndSubmitTransaction({ 
    ...
    final _path = r'/chains/{chain}/hsm/submit'.replaceAll('{' r'chain' '}', encodeQueryParameter(_serializers, chain, const FullType(ChainName)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignData200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SignData200Response>> signData({ 
    ...
    final _path = r'/chains/{chain}/hsm/sign'.replaceAll('{' r'chain' '}', encodeQueryParameter(_serializers, chain, const FullType(ChainName)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SignData200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SignData200Response),
      ) as SignData200Response;
    ...
    return Response<SignData200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
